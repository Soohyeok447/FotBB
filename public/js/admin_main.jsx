...
document.getElementById("btn_user").onclick = function() {
    ...
    ReactDom.render(<Filter rendered = {false}/>,document.querySelector('#filteringDB_component'));
}
...
document.getElementById("btn_filteringDB").onclick = function() {
    console.log('filteringDB버튼 클릭');
    ...
    ReactDom.render(<Report rendered = {false}/>,document.querySelector('#report_component'));
    ReactDom.render(<SendEmail rendered = {false}/>,document.querySelector('#sendemail_component'));
    ReactDom.render(<Filter rendered = {true}/>,document.querySelector('#filteringDB_component'));
}