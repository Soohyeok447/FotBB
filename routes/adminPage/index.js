...
//밴유저관리 페이지
router.post("/user_unban", isLoggedIn, Controller.user_unban);
//밴유저검색 ajax
router.get("/ban_search/:email", isLoggedIn, Controller.banned_search);

//신고유저관리 페이지
router.get("/report", isLoggedIn, Controller.report);
router.post("/report_ban", isLoggedIn, Controller.report_ban);
router.post("/report_changeid", isLoggedIn, Controller.report_changeid);
router.get("/report_search/:email", isLoggedIn, Controller.report_search);
router.get("/reportteststst",isLoggedIn, Controller.reportteststst)
// //로그관리 페이지
